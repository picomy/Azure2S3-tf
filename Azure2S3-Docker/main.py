...
src_azure_key = secretDict["azure_storage_key"]
...
## Update the s3 ak&sk
conf["src-azure"]["key"] = src_azure_key
conf["dst-s3"]["access_key_id"] = s3_aws_ak
conf["dst-s3"]["secret_access_key"] = s3_aws_sk
...
subprocess.run(["/usr/bin/rclone", "copyto", "src-azure:" + srcpath, "dst-s3:" + dstpath, "-P", "--transfers", "16", "--checkers", "16"])
